...
public class SystemCommandExecutor {
	 ...
	 */
	public SystemCommandExecutor(final List<String> commandInformation, String threadName) {
	...
	public int executeCommand() throws IOException, InterruptedException {
		...
		try {
			...
			inputStreamHandler = new ThreadedStreamHandler(inputStream,
					stdOutput, adminPassword, true, threadName);
			errorStreamHandler = new ThreadedStreamHandler(errorStream, true, threadName);
